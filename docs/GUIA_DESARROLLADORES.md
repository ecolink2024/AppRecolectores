...
**Restricción:** no se puede agregar/editar parada en ruta `completada` o `cerrada` (409 en API; botón deshabilitado en UI). En Historial las paradas son solo lectura; para editar paradas de `completada`, reactivar la ruta primero.
