...
**Cambios recientes (jun 2026):** **Preparación de insumos**; tablas operario con scroll; **Ver detalle** de ruta/parada; **Obs. recolector** (`observaciones_recolector`) y **cestos** en carga de campo; tipo de cliente **Punto** (`RECOLECCION_TIPOS_CLIENTE` en `constants.ts`); Maps recolector con GPS (`openGoogleMapsUrl`); firmas en Storage; WhatsApp **Avisar**; cierre operario; migraciones en `supabase/apply-pending-operativo.sql` (incl. `20260606120000`, `20260607120000`).
