        ...
        <dd className="flex items-center justify-end gap-2 font-medium text-zinc-900 dark:text-zinc-50">
          ...
          {showWhatsapp && (
            <a
              ...
              aria-label={`WhatsApp con ${datos.telefono}`}
              className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white active:bg-[#1da851]"
            >
              <WhatsAppIcon />
            </a>
          )}
